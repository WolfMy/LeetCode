...
| 编号 | 难度 |          题目          | 题解思路                               | 执行结果                                       |
| :--: | :--: | :--------------------: | :------------------------------------- | :--------------------------------------------- |
| 103  | 中等 | 二叉树的锯齿形层次遍历 | [1] BFS+双端队列<br />[2] DFS+双端队列 | [1] 40 ms    13.6 MB<br />[2] 40 ms    13.6 MB |
| 107  | 简单 |  二叉树的层次遍历-ii   | [1] 递归算法<br />[2] 迭代算法         | [1] 64 ms    14.1 MB<br />[2] 32 ms    13.7 MB |
| 127  | 中等 |        单词接龙        | [1] 图论+BFS<br />[2] 图论+双向BFS     | [1] 124 ms  17.2 MB<br />[2] 84 ms    17.3 MB  |

**2020.03.03** 栈

| 编号 | 难度 |    题目    | 题解思路                       | 执行结果                                     |
| :--: | :--: | :--------: | :----------------------------- | :------------------------------------------- |
|  20  | 简单 | 有效的括号 | 栈                             | 32 ms   13.5 MB                              |
|  22  | 中等 |  括号生成  | [1] 递归暴力法<br />[2] 回溯法 | [1] 52 ms   13.4 MB<br />[2] 36 ms   13.7 MB |

**2020.03.04** 栈

| 编号 | 难度 |       题目       | 题解思路     | 执行结果       |
| :--: | :--: | :--------------: | :----------- | :------------- |
|  71  | 中等 |     简化路径     | 分割路径+栈  | 48 ms  13.4 MB |
| 144  | 简单 | 二叉树的前序遍历 | 迭代算法     | 48 ms  13.5 MB |
| 150  | 中等 | 逆波兰表达式求值 | 边迭代边入栈 | 32 ms  13.7 MB |

**2020.03.05** 栈

| 编号 | 难度 |       题目       | 题解思路                             | 执行结果                                    |
| :--: | :--: | :--------------: | :----------------------------------- | :------------------------------------------ |
| 155  | 简单 |      最小栈      | [1] 同步辅助栈<br />[2] 不同步辅助栈 | [1] 76 ms   16.5 MB<br />[2] 128 ms 16.6 MB |
| 225  | 简单 |   用队列实现栈   | 两个队列                             | 32 ms    13.4 MB                            |
| 173  | 中等 | 二叉搜索树迭代器 | 扁平化二叉搜索树                     | 172 ms  19.5 MB                             |
|  42  | 困难 |      接雨水      | [1] 双指针<br />[2] 栈               | [1] 60 ms   13.7 MB<br />[2] 48 ms   14 MB  |

**2020.03.07** 位运算

| 编号 | 难度 |       题目       | 题解思路                       | 执行结果                                       |
| :--: | :--: | :--------------: | :----------------------------- | :--------------------------------------------- |
| 136  | 简单 | 只出现一次的数字 | [1] 数学方法<br />[2] 位运算   | [1] 36 ms    15.2 MB<br />[2] 36 ms    14.8 MB |
|  78  | 中等 |       子集       | [1] 递归算法<br />[2] 回溯算法 | [1] 36 ms    13.6 MB<br />[2] 48 ms    13.6 MB |

**2020.03.09** 位运算

| 编号 | 难度 |        题目         | 题解思路                                 | 执行结果                                       |
| :--: | :--: | :-----------------: | :--------------------------------------- | :--------------------------------------------- |
| 137  | 中等 | 只出现一次的数字-ii | [1] 数学方法<br />[2] 位运算（掩码思想） | [1] 56 ms    14.9 MB<br />[2] 44 ms    14.7 MB |
| 169  | 简单 |      多数元素       | [1] 哈希表                               | [1] 52 ms    14.8 MB                           |
